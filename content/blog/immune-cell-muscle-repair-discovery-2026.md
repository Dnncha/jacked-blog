...
1. **Macrophages infiltrate damaged muscle tissue** — These aren't resident macrophages already in the muscle; they're summoned from elsewhere in the body after injury occurs.

2. **They form synaptic-like contacts** — Using advanced imaging, researchers watched macrophages physically connect to muscle fibers (myofibers) in a structure remarkably similar to a neuron synapse.

3. **Calcium ions are delivered directly** — Within 10 to 30 seconds of forming these connections, macrophages release calcium ions directly onto the muscle fibers, triggering electrical activity that kickstarts the repair process.

4. **Muscle twitches begin almost immediately** — The researchers could literally activate macrophages and observe subtle muscle twitches within seconds.
