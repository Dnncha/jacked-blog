...
1. **Inhale deeply** before the lift - we're talking full diaphragmatic breath, belly expansion, not just chest breathing
2. **Hold your breath** and brace - engage your core, obliques, and pelvic floor simultaneously
3. **Exhale** partially during the hard part of the lift (typically the lockout), or hold until the rep is complete
...
| Goal | Breathing Strategy |
|------|-------------------|
| Max strength | Valsalva (hold through rep) |
| Hybrids (strength + size) | Modified Valsalva |
| Endurance/Hypertrophy | Power breathing |
| Recovery/Technique | Natural breathing |

## The Bottom Line

1. **Use Valsalva for heavy compound lifts** (squat, deadlift, bench, OHP) where stability matters
2. **Hold your breath through the hard part** - not just the easy part
3. **Brace harder than you think** - if you can breathe comfortably, you're not braced enough
4. **Reset fully between reps** - new breath, new brace, new focus
5. **Know when to modify** - high reps, certain conditions, and isolation work need different approaches
...
1. Hakkinen K, et al. Neuromuscular adaptations during strength training in young and older men. *Journal of Strength and Conditioning Research*. 1998.

2. Sato K, et al. The effect of increase in intra-abdominal pressure on spinal stability. *Journal of Strength and Conditioning Research*. 2019.
