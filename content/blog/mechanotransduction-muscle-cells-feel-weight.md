...
1. **Mechanical Load**: You perform a set — let's say squats. The muscles experience tension, stretch, and contract against resistance.

2. **Sensor Activation**: Mechanosensors (integrins, Piezo1, FAK) detect the physical changes in the muscle cell membrane and cytoskeleton.

3. **Signal Transmission**: These sensors activate downstream pathways including:
   - mTOR (mechanistic target of rapamycin) — the master regulator of muscle protein synthesis
   - MAPK/ERK pathway — promotes cell growth and differentiation
   - IGF-1/Akt pathway — supports muscle survival and growth

4. **Nuclear Response**: Activated signaling pathways cause YAP/TAZ to translocate to the nucleus, where they co-activate transcription factors that increase expression of growth-related genes.

5. **Protein Synthesis**: The cell ramps up muscle protein synthesis, building new sarcomeres (the basic contractile units) and increasing muscle fiber cross-sectional area.
...
1. ScienceDirect (2025). "Load-induced human skeletal muscle hypertrophy: Mechanisms, myths, and misconceptions"
2. Frontiers in Medicine (2025). "Dual roles of mTOR in skeletal muscle adaptation"
