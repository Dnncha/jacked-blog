...
1. **Downregulation of myostatin expression**: Some studies show epicatechin can reduce the production of myostatin at the genetic level
2. **Follistatin increase**: Epicatechin may increase follistatin, a protein that counteracts myostatin
3. **Improved muscle fiber function**: The compound appears to enhance the activity of muscle stem cells (satellite cells)
