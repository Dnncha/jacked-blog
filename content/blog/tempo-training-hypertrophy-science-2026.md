...
- **Fast eccentric group:** 1-second lowering phase
- **Slow eccentric group:** 4-second lowering phase

Both groups trained with the same relative load until failure. The results:

- The slow eccentric group had significantly greater time under tension
- The fast eccentric group completed more total reps
- **Hypertrophy was greater in the slow eccentric group** for the quadriceps
...
- Use a **3-4 second eccentric phase** on compound movements
- Maintain a **controlled but not artificially slow concentric** (1-2 seconds)
- Pause briefly (1 second) in stretched positions
- Example tempo: **3/1/2/0** or **4/1/1/0**

### For Strength Development

- Use natural, fast concentric velocities
- Don't artificially slow the lifting phase
- Focus on explosive intent even if the weight is heavy
- Example tempo: **2/0/1/0** or even faster

### For Muscle Endurance

- Slower tempos increase time under tension
- This can enhance metabolic stress
- Use tempos like **3/1/3/0** for higher-rep sets
...
- Training with intensity ( proximity to failure)
- Adding weight, reps, or sets over time
- Controlling the weight through the full range of motion
- Choosing a tempo that feels challenging but manageable
